...
public interface AdminService {
	...
	default boolean validateId(String courseId) {
		return courseId.matches(idRule);
	}
	...
	Faculty saveFacultySkill(Faculty faculty);
	
	Faculty saveFacultySkillset(List<String> skillSet);
